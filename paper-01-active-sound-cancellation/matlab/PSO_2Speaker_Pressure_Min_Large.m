...
% range of frequency 
Ffinal=40;                  % final frequency of the simulation
fs=2;                       % number of samples (array strategy)
fbegin=20;
...
Cost_no=zeros(1,fs);
disp(['The optimization for Large system with force as ' num2str(Force.Amp) 'N' ])
for i = 1:fs
...
save(['TwoSpeaker_Large_with_Force ' num2str(Force.Amp) ' ' ])
