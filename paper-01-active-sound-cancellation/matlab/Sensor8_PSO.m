...
mic(2,:)=[1/3, 1/2, 1].*[dimension.x, dimension.y, dimension.z]; % on the roof in line with the headrest position
mic(3,:)=[1/3, 1/4, 1].*[dimension.x, dimension.y, dimension.z]; % Headrest position
mic(4,:)=[1/3, 0, 3/5].*[dimension.x, dimension.y, dimension.z];
mic(5,:)=[1/3, 1, 3/5].*[dimension.x, dimension.y, dimension.z];
mic(6,:)=[0, 1/2, 1/2].*[dimension.x, dimension.y, dimension.z];


%% Headrest Position
Pinterest=[0.833, 0.325, 0.84].*[dimension.x, dimension.y, dimension.z];
...
save(['PSOWeightedSensorL 5micForceNeg' num2str(Force.Amp) ' ' ])
